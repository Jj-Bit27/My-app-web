...
import Input from "../Access/Input";
...
function CardForgotPassword({
  ...
  return (
    <div className="max-w-md w-full bg-slate-400 dark:bg-zinc-800 bg-opacity-50 backdrop-filter backdrop-blur-xl rounded-2xl shadow-xl overflow-hidden">
      <div className="p-8">
